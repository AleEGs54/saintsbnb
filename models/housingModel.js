 ...
 * @property {mongoose.Schema.Types.ObjectId} userId.required - Reference to the host/admin user who owns this listing
...
const housingSchema = new mongoose.Schema(
    {
        ...
        userId: {
            // Reference to the User (Host/Admin) who created this listing

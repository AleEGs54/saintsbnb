...
const { calendarValidationRules, validate } = require('../utilities/validation');
const { isAuthenticated } = require('../auth/authenticate');

// Create a new calendar entry
router.post('/', isAuthenticated, calendarValidationRules, validate, calendarController.createCalendarEntry);
...
router.put('/:id', isAuthenticated, calendarValidationRules, validate, calendarController.updateCalendarEntry);
